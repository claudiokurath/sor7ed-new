...
export const metadata = { title: 'Blog — SOR7ED', description: 'Honest, practical reads on ADHD, autism, overwhelm, money, and everything in between.' };
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#08080A' }}>
      ...
      <section style={{ padding: '4rem 6%' }}>
        {articles.length === 0 ? (
          <p style={{ color: 'rgba(255,255,255,0.3)' }}>No articles yet.</p>
        ) : (
