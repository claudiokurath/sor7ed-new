...
export default async function HomePage() {
  ...
  return (
    <div className="h-screen overflow-y-auto snap-y snap-mandatory scroll-smooth">
      ...
      {featuredTool && (
        <section className="h-dvh snap-start border-b-2 border-white/10 flex flex-col justify-center" style={{ position: 'relative', overflow: 'hidden' }}>
        <img src="/images/bg_section_tools.png" alt="" aria-hidden="true" style={{ position: 'absolute', inset: 0, width: '100%', height: '100%', objectFit: 'cover', objectPosition: 'right center', opacity: 0.2, pointerEvents: 'none' }} />
